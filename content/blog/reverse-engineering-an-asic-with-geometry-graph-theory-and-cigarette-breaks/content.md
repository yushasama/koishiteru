...
To place a new polygon, the R-tree compares every group's bounding box and chooses the group with the smallest increase in area. If there is a tie, the group with the smaller current area is chosen.
