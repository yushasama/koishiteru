    ...
    <section className="mb-14">
      ...
      <ul>
        {books.map((book, i) => (
          <li
            key={i}
            className={`group cursor-pointer px-2 py-4 sm:py-5 transition-all hover:bg-white/[0.02] hover:pl-3 hover:border-l-2 hover:border-violet-500/70 ${i > 0 ? 'border-t border-white/5' : ''}`}
          >
