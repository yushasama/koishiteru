...
export function generateMetadata(): Metadata {
  ...
  if (!post) return {};
  const privateMetadata = post.requiresAccess ? { robots: { follow: false, index: false, noarchive: true, nocache: true, nosnippet: true } } : {};
  return { title: `${post.title} | 恋してる`, description: post.excerpt, ...createBlogImageMetadata(post.thumbnail), ...privateMetadata };
}
