...
export const metadata: Metadata = post ? { title: `${post.title} | 恋してる`, description: post.excerpt, ...createBlogImageMetadata(post.thumbnail), robots: { follow: false, index: false, noarchive: true, nocache: true, nosnippet: true } } : {};
